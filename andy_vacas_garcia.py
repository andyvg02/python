class Libro:
    ...
    #Iniciamos la clase y creamos los objetos titulo,autor,isbn y disponible.
    def __init__(self, titulo, autor, isbn, disponible=True):
        self.titulo = titulo
        self.autor = autor
        self.isbn = isbn
        self.disponible = disponible
    #Si el objeto dentro de disponible es False, printamos: "Libro 'nombre del libro' prestado. Si no printamos: "Libro 'titulo' ya no está disponible".
    def prestar(self): 
        if self.disponible:
    ...
    #Si no esta disponible Cambiamos disponible=True y printamos "Libro 'titulo' devuelto.", si no: "El libro 'titulo' ya estaba disponible."
    def devolver(self):
    ...
    # pondremos en estado "Disponible" si disponible es True, sino Prestado
    def __str__(self):
...
def agregar_libro(biblioteca):
    ...
    print(f"El libro '{titulo}' se ha añadido a la biblioteca.")

# Función para prestar un libro
def prestar_libro(biblioteca):
    isbn = input("Ingresa el ISBN del libro que deseas prestar: ")
...
def buscar_libro(biblioteca):
    isbn = input("Ingresa el ISBN del libro que deseas buscar: ")
    for libro in biblioteca:
        if libro.isbn == isbn:
            print(libro)  # Usa el método __str__ para mostrar los detalles
            return
    print(f"No se ha encontrado ningún libro con el ISBN {isbn}.")
